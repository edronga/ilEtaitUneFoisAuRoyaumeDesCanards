...
bAction = function(){
    if (CACHE.eventTracker['hasMetMartGirl'] === undefined){
        bText = `Je suis un peu triste...\nMon chat est malade. Je lui ai demandé ce qu'il avait et il m'a répondu que j'étais moche et débile.\nJ'espère que mon chat à un cancer.`
    ...
    switch (CACHE.heldObject.value){
        case 'money':
            bText = `Coucou encore ! Qu'est-ce que ce sera aujourd'hui ? Un piège à chat ? Une muselière pour chat ? Du poison pour euthanasier son chat ? Du beurre ?`
